...
> [lab-18](../lab-18-enable-gpudirect-tcpx/).
...
| Inter-node, silent fallback | **23.7 / ~28.6 GB/s** | **≈13×** worse, zero errors ([lab-12](../lab-12-scaling-sweep/) / [lab-06](../lab-06-2node-nccl-collectives/)) |
