...
| :--- | :--- | :--- | :--- | :--- |
| **Fabric** | move off plain TCP | **new** cluster (Dataplane V2 + multi-networking are create-time-only) + multi-network pool + GPUDirect plugin DaemonSet | single-gVNIC **23.7–28.6 GB/s** floor ([lab-12](../labs/lab-12-scaling-sweep/)) | **measured on both rungs**: TCPX 4 rails **83.27 GB/s** (**3.5×**, [lab-18](../labs/lab-18-enable-gpudirect-tcpx/)) · TCPXO 8 rails **317.84 GB/s** (**13.4×**, [lab-22](../labs/lab-22-fabric-diagnostics/)) · [doc-21](../docs/part6-architecture-gcp-integration/21-gke-network-design.md) |
